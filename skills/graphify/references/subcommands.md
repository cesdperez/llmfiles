...
These are the branch flows reached only for specific invocations. The main build
pipeline (Steps 1-9) and Honesty Rules live in [SKILL.md](../SKILL.md); several
sections below say "run Steps 4-8" / "Steps 5-9" and mean those steps in SKILL.md.
